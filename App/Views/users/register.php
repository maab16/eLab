	...
	?>
		<form id="registration" action="" method="post">
			<div class="col-sm-5 register">	
				...
				<div class="col-sm-12">
					<input type="text" name="fname" class="form-control" id="fname" placeholder="First Name" value="<?= $input::get('fname');?>">
				</div>
				<div class="col-sm-12">
					<input type="text" name="lname" class="form-control" id="lname" placeholder="Last Name" value="<?= $input::get('lname');?>">
				</div>
				<div class="col-sm-12">
				...
				<div class="col-sm-12">
					<input type="text" name="phone" class="form-control" id="phone" placeholder="Enter Phone Number (optional)"  value="<?= $input::get('phone');?>">
				</div>
				<div class="col-sm-12">
